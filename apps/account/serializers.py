...
from .tasks import send_activation_code, send_artist_activation_code
...
class UserRegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('username', 'email', 'image', 'password', 'password_confirm')
...
class ArtistRegistrationSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        user = User.objects.create_user(**validated_data)
        user.create_activation_code()
        send_artist_activation_code.delay(user.email, user.activation_code)
        return user
