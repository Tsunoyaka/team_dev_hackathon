    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='satanael2.png', upload_to='music_images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like_music', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='music_likes', to='music.music')),
